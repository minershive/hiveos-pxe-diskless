...
grub_target_cc_version='gcc-5 (Ubuntu 5.4.0-6ubuntu1~16.04.12) 5.4.0 20160609'
...
grub_target_cppflags='-Wno-unused-but-set-variable -Wall -W -I$(top_srcdir)/include -I$(top_builddir)/include  -DGRUB_MACHINE_EFI=1 -DGRUB_MACHINE=X86_64_EFI -m64 -nostdinc -isystem /usr/lib/gcc/x86_64-linux-gnu/5/include'
...
grub_package="grub"
grub_package_string="GRUB 2.02~beta2-36ubuntu3.29"
grub_package_version="2.02~beta2-36ubuntu3.29"
